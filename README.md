...
* J. Yang, H. Li, D. Campbell, Y. Jia, *Go-ICP: A Globally Optimal Solution to 3D ICP Point-Set Registration*, IEEE Transactions on Pattern Analysis and Machine Intelligence (T-PAMI), 2016. [PDF](http://jlyang.org/tpami16_go-icp_preprint.pdf)
